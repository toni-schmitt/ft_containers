...
namespace ft
{
	...
	public:
		...
		random_access_iterator(const random_access_iterator<typename Container::value_type, Container> &cpy) : _ptr(cpy.base()) {}
	...
	/* Arithmetic Operators */
	template <class T, class Container>
	random_access_iterator<T, Container> operator+(typename random_access_iterator<T, Container>::difference_type n, const random_access_iterator<T, Container> &rand_acc_iter) { return random_access_iterator<T, Container>(rand_acc_iter.base() + n); }
	template <class T, class Container>
	random_access_iterator<T, Container> operator-(typename random_access_iterator<T, Container>::difference_type n, const random_access_iterator<T, Container> &rand_acc_iter) { return random_access_iterator<T, Container>(rand_acc_iter.base() - n); }
